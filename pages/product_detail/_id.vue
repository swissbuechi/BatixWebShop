<template>
  <div class="section">
    <div class="card is-clearfix columns">
      <figure id="product-image" class="card-image is-480x480 column is-one-thirds">
        <!-- <img src="https://bulma.io/images/placeholders/480x480.png" /> -->

       <div v-if="this.$store.getters.getProductById(this.$route.params.id).title.indexOf('Rot') !== -1">
          <img src="../../static/images/red.png" />
        </div>

       <div v-if="this.$store.getters.getProductById(this.$route.params.id).title.indexOf('Grün') !== -1">
          <img src="../../static/images/green.png" />
        </div>

        <div v-if="this.$store.getters.getProductById(this.$route.params.id).title.indexOf('Blau') !== -1">
